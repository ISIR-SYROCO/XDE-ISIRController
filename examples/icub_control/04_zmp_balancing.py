...
ctrl.task_updater.register( xic.task_controller.ZMPController( CoMTask, dynModel, zmp_traj, QonR=1e-6, horizon=1.8, dt=dt, H_0_planeXY=lgsm.Displacement(), stride=3, gravity=9.81) )
