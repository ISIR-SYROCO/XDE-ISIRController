...
dt = 0.01
wm = xwm.WorldManager()
wm.createAllAgents(dt, lmd_max=.01, uc_relaxation_factor=0.1)
...
rname = "robot"
fixed_base = False
robotWorld = xrl.createWorldFromUrdfFile(xr.icub_simple, rname, [1.5,0,0.6,0.707,0,0,0.707], fixed_base, .003, 0.001)
...
#waistTask   = ctrl.createFrameTask("waist", rname+'.waist', lgsm.Displacement(), "RZ", w=1.0, kp=25., pose_des=lgsm.Displacement(0,0,.58,0.707,0,0,0.707))
...
zmp_ref = walkingActivity.goTo([.0,-.5], relative_pos=True)
