...
ctrl.add_updater( xic.task_controller.ZMPController( CoMTask, ctrl.getModel(), [[-0.03,0.02]], RonQ=1e-6, horizon=1.8, dt=dt, H_0_planeXY=lgsm.Displacement(), stride=3, gravity=9.81) )
